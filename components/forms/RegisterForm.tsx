...
const RegisterForm = ({ user }: { user: User }) => {
  ...
  const onSubmit = async (values: z.infer<typeof PatientFormValidation>) => {
    ...
    try {
      ...
      if (newUser) {
        redirect(`/dashboard/patients/${user.$id}/login`);
    ...
    <div>
      <Form {...form}>
        <form
          ...
          className="flex-1 space-y-12 align-middle"
        >
          <section className="space-y-4 flex-col center justify-center">
            <h1 className="header mb-2">Welcome 👋 </h1>
